...
qft_dg phase[0],phase[1],phase[2],phase[3],phase[4],phase[5],phase[6],phase[7],phase[8];
...
qft phase[0],phase[1],phase[2],phase[3],phase[4],phase[5],phase[6],phase[7],phase[8];
cp(-0.044399539924562) phase[8],sys[0];
cp(-0.088799079849124) phase[7],sys[0];
cp(-0.177598159698248) phase[6],sys[0];
cp(-0.355196319396496) phase[5],sys[0];
