...
qft_dg phase_0[0], phase_0[1], phase_0[2], phase_0[3], phase_0[4], phase_0[5], phase_0[6];
...
cry(1.1714210053478946) phase_0[6], ancilla[0];
qft phase_0[0], phase_0[1], phase_0[2], phase_0[3], phase_0[4], phase_0[5], phase_0[6];
cp(-0.177598159698248) phase_0[6], sys[0];
cp(-0.355196319396496) phase_0[5], sys[0];
cp(-0.710392638792992) phase_0[4], sys[0];
cp(-1.420785277585984) phase_0[3], sys[0];
