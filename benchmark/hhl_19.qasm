...
gate qft _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5, _gate_q_6, _gate_q_7, _gate_q_8, _gate_q_9, _gate_q_10, _gate_q_11, _gate_q_12, _gate_q_13, _gate_q_14, _gate_q_15, _gate_q_16 {
  h _gate_q_16;
  cp(pi/2) _gate_q_16, _gate_q_15;
  cp(pi/4) _gate_q_16, _gate_q_14;
  cp(pi/8) _gate_q_16, _gate_q_13;
...
cp(0.002774971245285125) phase_0[12], sys[0];
cp(0.0013874856226425624) phase_0[13], sys[0];
cp(0.0006937428113212812) phase_0[14], sys[0];
cp(0.0003468714056606406) phase_0[15], sys[0];
cp(0.0001734357028303203) phase_0[16], sys[0];
qft_dg phase_0[0], phase_0[1], phase_0[2], phase_0[3], phase_0[4], phase_0[5], phase_0[6], phase_0[7], phase_0[8], phase_0[9], phase_0[10], phase_0[11], phase_0[12], phase_0[13], phase_0[14], phase_0[15], phase_0[16];
...
cry(pi) phase_0[11], ancilla[0];
cry(pi) phase_0[12], ancilla[0];
cry(pi) phase_0[13], ancilla[0];
cry(pi) phase_0[14], ancilla[0];
cry(pi) phase_0[15], ancilla[0];
cry(1.1714210053478946) phase_0[16], ancilla[0];
qft phase_0[0], phase_0[1], phase_0[2], phase_0[3], phase_0[4], phase_0[5], phase_0[6], phase_0[7], phase_0[8], phase_0[9], phase_0[10], phase_0[11], phase_0[12], phase_0[13], phase_0[14], phase_0[15], phase_0[16];
cp(-0.0001734357028303203) phase_0[16], sys[0];
cp(-0.0003468714056606406) phase_0[15], sys[0];
cp(-0.0006937428113212812) phase_0[14], sys[0];
cp(-0.0013874856226425624) phase_0[13], sys[0];
