...
gate mcphase_0(_gate_p_0) _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5, _gate_q_6, _gate_q_7, _gate_q_8, _gate_q_9, _gate_q_10 {
  h _gate_q_10;
  cx _gate_q_7, _gate_q_10;
  tdg _gate_q_10;
  cx _gate_q_4, _gate_q_10;
...
gate mcx _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5, _gate_q_6, _gate_q_7, _gate_q_8, _gate_q_9, _gate_q_10 {
  h _gate_q_10;
  mcphase_0 _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5, _gate_q_6, _gate_q_7, _gate_q_8, _gate_q_9, _gate_q_10;
  h _gate_q_10;
}
gate Q _gate_q_0, _gate_q_1, _gate_q_2, _gate_q_3, _gate_q_4, _gate_q_5, _gate_q_6, _gate_q_7, _gate_q_8, _gate_q_9, _gate_q_10, _gate_q_11 {
...
h q[10];
x flag[0];
Q q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], flag[0];
Q q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], flag[0];
Q q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], flag[0];
Q q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], flag[0];
Q q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], q[8], q[9], q[10], flag[0];
