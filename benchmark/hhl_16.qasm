...
cp(0.0013874856226425624) phase[13],sys[0];
qft_dg phase[0],phase[1],phase[2],phase[3],phase[4],phase[5],phase[6],phase[7],phase[8],phase[9],phase[10],phase[11],phase[12],phase[13];
...
cry(pi) phase[12],ancilla[0];
cry(1.1714210053478946) phase[13],ancilla[0];
qft phase[0],phase[1],phase[2],phase[3],phase[4],phase[5],phase[6],phase[7],phase[8],phase[9],phase[10],phase[11],phase[12],phase[13];
cp(-0.0013874856226425624) phase[13],sys[0];
cp(-0.002774971245285125) phase[12],sys[0];
cp(-0.00554994249057025) phase[11],sys[0];
cp(-0.0110998849811405) phase[10],sys[0];
