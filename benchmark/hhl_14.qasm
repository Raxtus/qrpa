...
qft_dg phase[0],phase[1],phase[2],phase[3],phase[4],phase[5],phase[6],phase[7],phase[8],phase[9],phase[10],phase[11];
...
qft phase[0],phase[1],phase[2],phase[3],phase[4],phase[5],phase[6],phase[7],phase[8],phase[9],phase[10],phase[11];
cp(-0.00554994249057025) phase[11],sys[0];
cp(-0.0110998849811405) phase[10],sys[0];
cp(-0.022199769962281) phase[9],sys[0];
cp(-0.044399539924562) phase[8],sys[0];
